...
export const mockInstagramChannels: IChannelConfig[] = [
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Mi+Tienda&background=E1306C&color=fff',
    followers: 15200,
  },
];
...
export const mockFacebookChannels: IChannelConfig[] = [
  {
    ...
    avatar: 'https://ui-avatars.com/api/?name=Mi+Tienda&background=1877F2&color=fff',
    followers: 8500,
  },
];
...
export const mockInstagramAccounts: InstagramAccount[] = [
  {
    ...
    profilePicture: 'https://ui-avatars.com/api/?name=Mi+Tienda&background=E1306C&color=fff',
    followers: 15200,
  ...
  },
  {
    ...
    profilePicture: 'https://ui-avatars.com/api/?name=Outlet&background=833AB4&color=fff',
    followers: 3400,
    isBusinessAccount: true,
...
export const mockFacebookPages: FacebookPage[] = [
  {
    ...
    picture: 'https://ui-avatars.com/api/?name=Mi+Tienda&background=1877F2&color=fff',
    followers: 8500,
  ...
  },
  {
    ...
    name: 'Mi Tienda Outlet',
    category: 'Tienda de ropa',
    picture: 'https://ui-avatars.com/api/?name=Outlet&background=1877F2&color=fff',
    followers: 3200,
    isMessagingEnabled: true,
  },
  {
    ...
    picture: 'https://ui-avatars.com/api/?name=Blog&background=4267B2&color=fff',
    followers: 1200,
